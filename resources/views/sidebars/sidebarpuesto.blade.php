...
<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#inventario" aria-expanded="true" aria-controls="inventario">
            <i class="fas fa-store-alt"></i><span>Inventario</span>
        </a>
    ...
    <li class="nav-item">
        ...
        <div id="envios" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item font-weight-bold" href="#" @click="menu=5">Envíos Realizados</a>
                <a class="collapse-item font-weight-bold" href="#" @click="menu=6">Envíos Recibidos</a>
            </div>
        </div>
    </li>
