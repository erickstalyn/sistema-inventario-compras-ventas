            ...
            <div class="container-fluid">
                  ...
                  <div class="col-md-3">
                    <div class="input-group">
                      ...
                      <input
                        ...
                        v-model="DatosServicio.documento"
                        autofocus
                    ...
                    <div class="col-md-2">
                      <div class="input-group">
                        ...
                        <input
                          ...
                          class="form-control form-control-sm"
                          readonly
                          v-model="DatosProveedor.documento"
                        />
                      </div>
                    </div>
                    <div class :class="Modal.numero == 2 ? 'col-md-3': 'col-md-4'">
                      <div class="input-group">
                        ...
                        <input
                          ...
                          class="form-control form-control-sm"
                          readonly
                          v-model="DatosProveedor.nombres"
                        />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="input-group">
                        ...
                        <input
                          ...
                          class="form-control form-control-sm"
                          readonly
                          v-model="DatosProveedor.apellidos"
                        />
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-10">
                      <div class="input-group">
                        ...
                        <input
                          type="text"
                          class="form-control form-control-sm"
                          v-model="DatosProveedor.razon_social"
                          :readonly="DatosServicio.readonly"
                        />
                      </div>
                    </div>
                  </div>
              ...
              <div v-if="Modal.numero == 2">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      <span class="font-weight-bold">Enviado a:</span>
                      {{Abasto.nombre_centro}}
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-4" v-if="Abasto.tipo_abasto == 1">
                    ...
                    <div class="row form-group overflow-auto" style="height: 15.5rem;">
                      <div class="col-md-12">
                        <div v-if="ListaPago.length">
                          <table
                            class="table table-borderless table-striped table-sm text-gray-900"
                          >
                            <thead>
                              <tr class="table-info">
                    ...
                    <div class="row">
                      <div class="col-md-12 text-right pr-5">
                        <span class="font-weight-bold">Monto pagado:</span>
                        <span class="text-success">s/{{getSumaPagos}}</span>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12 text-right pr-5">
                        <span class="font-weight-bold">Monto faltante:</span>
                        <span class="text-danger">s/{{(Abasto.total_ver - getSumaPagos).toFixed(2)}}</span>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12 text-right pr-5">
                        <span class="font-weight-bold">Costo total:</span>
                        <span>s/{{Abasto.total_ver}}</span>
                      </div>
                    </div>
                  </div>
                  <div
                    class="ml-auto container"
                    :class="[Abasto.tipo_abasto ? 'col-md-8' : 'col-md-12']"
                  >
                    <div class="row">
                      <div class="col-md-3 p-0">
                        <p class="font-weight-bold">LISTA DE ITEMS</p>
                      ...
                      <div class="col-md-3">
                        <div class="input-group">
                          <label for="tipo" class="font-weight-bold">Tipo:</label>
                          <div v-if="Abasto.tipo_abasto">Crédito</div>
                          <div v-else>Contado</div>
                        </div>
                      </div>
                    </div>
                    <div class="row form-group ec-table-modal overflow-auto">
                  ...
                  <div class="col-md-7">
                    <div class="input-group">
                      ...
                      <input
                        ...
                        class="form-control form-control-sm"
                        v-model="Pago.monto"
                        @keyup.enter="agregarListaPago()"
                      />
                      <button
                        type="button"
                        class="btn btn-sm btn-primary"
                        @click="agregarListaPago()"
                        :disabled="getSumaPagos == Abasto.total_ver"
                      >Registrar</button>
                    </div>
                  </div>
                  <div class="col-md-1"></div>
            ...
            <div class="row form-group col-md-12 d-flex justify-content-around">
              <div v-if="Modal.accion">
                <button
                  ...
                  :class="[Modal.accion == 'Generar comprobante' ? 'btn btn-danger' : 'btn btn-success']"
